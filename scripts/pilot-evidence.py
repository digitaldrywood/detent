...
SUITES = {
    "hubserver": [
        ...
        "TestPilotHostedArtifactGatewayWithoutRunners",
        "TestPilotHostedTwoRepositoryReadiness",
        "TestHostedIndependentChangeChecks",
        "TestHostedRunnerChangeChecks",
        "TestHostedWorkAccess",
        "TestHostedChangePolicyJourney",
        "TestHostedChangePolicyAuthorization",
        "TestHostedBrowserFirstOrganization",
        "TestHostedBrowserProviderAccountSelection",
