...
- Keep strict output decoding and argument-boundary assertions. Repeat focused coverage runs and race tests. Before isolating coverage data, verify the helper does not exercise production code whose counters must be merged into the parent profile.
