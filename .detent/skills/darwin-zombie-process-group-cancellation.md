...
- Run focused affected-platform tests. Run race validation only where the project protocol permits it, and distinguish a newly reproduced cancellation defect from any earlier uninstrumented timeout.
