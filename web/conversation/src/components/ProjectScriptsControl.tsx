...
import {
  ConversationActionsMenuGroup,
  useConversationActions,
} from "~/app/adapters/conversationActions";
...
export default function ProjectScriptsControl({
  ...
  // Detent's insertion (see the header note).
  ...
  return (
    <>
        ...
        <Group aria-label="Project scripts">
          ...
          >
            ...
            <MenuPopup align="end">
              ...
              {importMenuItems}
              {/* Detent's insertion. */}
              <ConversationActionsMenuGroup itemClassName={dropdownItemClassName} />
      ...
      ) : importableScripts.length > 0 || conversationActions.length > 0 ? (
        <Menu
          highlightItemOnHover={false}
