import { METHODS } from "./session.ts";
...
import type { DetentHubMethods as WsRpcProtocolClient, RpcSession } from "./session.ts";
...
export type EnvironmentSubscriptionRpcTag = typeof METHODS.subscribeConversation;
