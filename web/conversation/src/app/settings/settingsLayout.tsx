...
export function SettingsWarning({
  ...
  return (
    <div
      role="status"
      className="flex items-start gap-2.5 rounded-[10px] border border-warning/30 bg-warning-surface px-3.5 py-3 text-[13px] text-warning-foreground"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
...
export type SettingsPageWidth = WorkspacePageWidth;
