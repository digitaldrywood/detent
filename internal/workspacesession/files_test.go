...
func TestNormalizePath(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "surrounding spaces kept", value: " report ", want: " report "},
		{name: "spaces in a nested name kept", value: "docs/ notes.md", want: "docs/ notes.md"},
		{name: "whitespace-only name kept", value: " ", want: " "},
		{name: "trailing newline kept", value: "log\n", want: "log\n"},
