...
func demoScenarioDefinitions() []demoScenario {
	return []demoScenario{
		...
		{ID: "fleet-active-hours", Route: "/fleet", WaitSelector: "#snapshot", Page: "fleet", Variant: "active-hours", HideFromManifest: true},
		...
		{ID: "health-active-hours", Route: "/health/ui", WaitSelector: "#health-dashboard", Page: "health", Variant: "active-hours", HideFromManifest: true},
		...
		{ID: "board-counts-single-cached", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-single-cached", HideFromManifest: true},
		{ID: "board-counts-complete-degraded", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-complete-degraded", HideFromManifest: true},
		{ID: "board-counts-paused-complete", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-paused-complete", HideFromManifest: true},
		{ID: "board-counts-live", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-live", HideFromManifest: true},
		{ID: "board-counts-partial", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-partial", HideFromManifest: true},
		{ID: "board-counts-unknown", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-counts-unknown", HideFromManifest: true},
		...
		{ID: "board-admission-proposals-several", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "admission-proposals-several", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
		...
		{ID: "board-card-facts", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "card-facts", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
		...
		{ID: "board-card-single-blocker", Route: "/", WaitSelector: "#board-lanes", Page: "fleet-kanban", Variant: "board-card-single-blocker", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
