...
func demoScenarioDefinitions() []demoScenario {
	return []demoScenario{
		...
		{ID: "board-admission-proposals-one", Route: "/", WaitSelector: "#board-alerts", Page: "fleet-kanban", Variant: "admission-proposals-one", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
		{ID: "board-admission-proposals-several", Route: "/", WaitSelector: "#board-alerts", Page: "fleet-kanban", Variant: "admission-proposals-several", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
