...
func demoScenarioDefinitions() []demoScenario {
	return []demoScenario{
		...
		{ID: "board-tracker-stale", Route: "/", WaitSelector: "#board-stale-data", Page: "fleet-kanban", Variant: "tracker-stale", KanbanMode: workflowconfig.KanbanModeReadOnly, HideFromManifest: true},
