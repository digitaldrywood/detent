...
func renderWorkflow(form templates.OnboardingForm, sourceRoot string) string {
	...
	b.WriteString("  blocked_recovery:\n")
	b.WriteString("    enabled: false\n")
	writeList(&b, "    ", "source_states", []string{"Blocked"})
	b.WriteString("    target_state: Rework\n")
	writeList(&b, "    ", "reason_codes", []string{"merge_conflict", "stale_base", "missing_current_head_ci"})
	...
	b.WriteString("#       kind: codex\n")
	b.WriteString("#       protocol: app-server\n")
	b.WriteString("#       command: codex app-server\n")
	...
	b.WriteString("#           type: workspaceWrite\n")
	b.WriteString("#           networkAccess: true\n")
	b.WriteString("#     - id: claude-worker\n")
	b.WriteString("#       kind: claude_code\n")
	b.WriteString("#       protocol: headless\n")
	b.WriteString("#       command: env CLAUDE_CONFIG_DIR=/var/lib/detent/claude/worker-1 claude\n")
	b.WriteString("#       options:\n")
	b.WriteString("#         permission_mode: bypassPermissions\n")
	b.WriteString("#         allowed_tools:\n")
	b.WriteString("#           - Bash\n")
	b.WriteString("#           - Edit\n")
	b.WriteString("#         disallowed_tools:\n")
	b.WriteString("#           - WebFetch\n")
	b.WriteString("#         extra_args:\n")
	b.WriteString("#           - --no-session-persistence\n")
	b.WriteString("#   routes:\n")
	b.WriteString("#     - name: validator-claude\n")
	b.WriteString("#       role: validator\n")
	b.WriteString("#       backend: claude-worker\n")
	b.WriteString("#       model: fable\n")
	b.WriteString("#     - name: default\n")
	b.WriteString("#       backend: codex-default\n")
	b.WriteString("#       model: gpt-5-codex\n")
	...
	b.WriteString("    enabled: false\n")
	b.WriteString("    # Recommended cheap override when enabled: gpt-5.4-mini.\n")
	b.WriteString("    # Watch rework-rate per validator model once cache/model telemetry lands.\n")
	b.WriteString("    model: \"\"\n")
	b.WriteString("    min_score: 0.8\n")
	b.WriteString("    max_inline_diff_bytes: 65536\n")
