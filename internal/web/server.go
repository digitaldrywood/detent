...
func (s *Server) registerRoutes() {
	...
	apiDashboardReadAuth := s.apiAuthWithOptions(apiAuthOptions{allowUICookie: true, allowLocalDashboardHTMX: true})
	apiDashboardMutateAuth := s.apiAuthWithOptions(apiAuthOptions{mutating: true, allowUICookie: true, allowLocalDashboardHTMX: true})
