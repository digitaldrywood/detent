...
func TestProjectKanbanCardForIssueMarksOnlyHumanOwnedReviewWaits(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{name: "human review gate", state: "Human Review", project: ProjectSmallMultiple{ID: "parable", ReviewPolicyConfigured: true, AutoPromoteEnabled: true, AutoPromoteGateKind: "human_review"}, want: true},
