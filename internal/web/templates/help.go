...
var helpDefinitions = map[helpTerm]helpEntry{
	...
	helpBlocked:             {Label: "Blocked", Description: "Issues Symphony cannot continue without human help, such as missing dependencies, auth, approvals, or required actions."},
	...
	helpBudget:              {Label: "Budget", Description: "Optional USD spend guardrails for the active project. If a cap is hit, Symphony refuses to start new work until the limit is raised or resets."},
	...
	helpDailyCap:            {Label: "Daily cap", Description: "The maximum USD this project may spend today. When it is reached, Symphony stops starting new sessions for the day."},
	...
	helpRecentSessions:      {Label: "Recent sessions", Description: "The last completed Codex sessions Symphony retained. Use it to audit what just happened without digging through logs."},
	...
	helpRunning:             {Label: "Running", Description: "Issues currently assigned to Codex and producing activity. Watch this to see how much work Symphony is actively driving right now."},
	...
	helpSettingsConfig:      {Label: "Global config", Description: "The startup config Symphony actually loaded. Check it when behavior does not match the file you expected to be active."},
	helpSettingsProjects:    {Label: "Projects", Description: "The project configs Symphony loaded, including tracker wiring, priority, weight, and pause state. Use it to confirm the scheduler sees the right work."},
	helpSettingsRuntime:     {Label: "Runtime paths", Description: "The local files and listener address used by this Symphony process. Check these when logs, database state, or the web server look wrong."},
	...
	helpThroughput:          {Label: "Token throughput", Description: "Tokens processed per second across running agents, shown as tps. It is a live pulse of how hard Symphony is working right now."},
	...
	helpRuntime:             {Label: "Runtime", Description: "How long this Symphony instance or agent session has been running. Long runtimes are worth checking when progress slows."},
}
