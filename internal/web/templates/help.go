...
var helpDefinitions = map[helpTerm]helpEntry{
	...
	helpProjectKanban:       {Label: "Project Kanban", Description: "Read-only project board grouped by configured Detent workflow states. Empty configured lanes are hidden until requested."},
