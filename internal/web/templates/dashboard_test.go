...
func TestDashboardRendersCompactProjectKanbanHeader(t *testing.T) {
	...
	for _, want := range []string{
		...
		`class="inline-flex size-4 shrink-0 items-center justify-center text-accent"`,
...
func TestDashboardRendersProjectSmallMultiples(t *testing.T) {
	...
	for _, want := range []string{
		"Fleet grid",
		"Detent project",
		`data-help-term="project-multiples"`,
