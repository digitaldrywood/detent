...
func workToolbar(data DashboardData, view boardView) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "</span></a><div class=\"flex h-9 overflow-hidden rounded-card border border-line bg-surface\" role=\"group\" aria-label=\"Work view\"><button type=\"button\" class=\"px-3 text-xs font-medium\" data-work-view=\"board\" aria-pressed=\"true\">Board</button> <button type=\"button\" class=\"border-l border-line px-3 text-xs font-medium text-sec\" data-work-view=\"list\" aria-pressed=\"false\">List</button></div><nav aria-label=\"Work pages\" class=\"flex items-center gap-2 text-xs text-sec\"><button type=\"button\" data-work-page-step=\"-1\" aria-label=\"Previous work page\" class=\"rounded-card border border-line px-2 py-2 disabled:opacity-50\">Previous</button> <span data-work-page-summary aria-live=\"polite\">Page 1</span> <button type=\"button\" data-work-page-step=\"1\" aria-label=\"Next work page\" class=\"rounded-card border border-line px-2 py-2 disabled:opacity-50\">Next</button></nav>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
