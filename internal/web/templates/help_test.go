...
func TestHelpScriptUsesStableSharedPopoverUtility(t *testing.T) {
	...
	for _, want := range []string{
		...
		"pointerout",
		"positionHelpTooltip",
		"replacementHelpTrigger",
		`trigger.dataset.helpScope === "runtime-identity"`,
		`trigger.closest("article")`,
		`tip.dataset.placement = "card"`,
		`trigger.closest("#app-sidebar[data-rail='true']")`,
		...
		"setActiveHelpTrigger(replacement)",
