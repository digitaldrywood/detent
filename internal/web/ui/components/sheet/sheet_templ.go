...
// templui component sheet - version: v1.12.0 installed by templui v1.12.0
...
func getSideClasses(side Side) string {
	...
	baseClasses := "fixed z-50 flex flex-col bg-page shadow-lg !transition-transform ease-in-out " +
