	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Href != "" && !p.Disabled {
			var templ_7745c5c3_Var2 = []any{utils.TwMerge(
				...
				"outline-none focus-visible:border-accent focus-visible:ring-accent/50 focus-visible:ring-[3px]",
...
func (b Props) variantClasses() string {
	...
	case VariantDestructive:
		return "bg-err text-white shadow-xs hover:bg-err/90 focus-visible:ring-err/20 dark:focus-visible:ring-err/40 dark:bg-err/60"
	case VariantOutline:
		return "border bg-page shadow-xs hover:bg-accent hover:text-page dark:bg-line/30 dark:border-line dark:hover:bg-line/50"
	case VariantSecondary:
		return "bg-elev text-text shadow-xs hover:bg-elev/80"
	case VariantGhost:
		return "hover:bg-accent hover:text-page dark:hover:bg-accent/50"
	case VariantLink:
		return "text-accent underline-offset-4 hover:underline"
	default:
		return "bg-accent text-page shadow-xs hover:bg-accent/90"
	}
}
