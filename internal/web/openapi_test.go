...
func TestServerOpenAPIRouteParity(t *testing.T) {
	...
	excluded := map[string]string{
		...
		routeKey(http.MethodGet, "/api/v1/visual-reviews/summary"):                                          "HTMX visual review summary",
		routeKey(http.MethodGet, "/api/v1/projects/:project_id/visual-reviews/:capture_id"):                 "private visual review host transport",
		routeKey(http.MethodGet, "/api/v1/projects/:project_id/visual-reviews/:capture_id/media/:asset_id"): "private visual review media transport",
		routeKey(http.MethodPut, "/api/v1/projects/:project_id/visual-reviews/:capture_id/draft"):           "private visual review draft transport",
		routeKey(http.MethodPost, "/api/v1/projects/:project_id/visual-reviews/import"):                     "local capture-agent import transport",
