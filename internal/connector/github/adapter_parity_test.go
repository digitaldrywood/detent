...
func TestProjectsV2ParityGateMatchesElixirAdapterFlow(t *testing.T) {
	...
	if issues[0].ID != "I_kw28" || issues[0].State != "Todo" || issues[0].Identifier != "digitaldrywood/symphony-go#28" {
