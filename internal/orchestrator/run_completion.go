...
func (o *Orchestrator) completeProgrammaticMergeWorkerResult(
	...
	if gate.AutomatedReviewPending(o.cfg.AutoPromote.Gate, issue.PullRequest.AutomatedReviewPending()) {
...
func mergeWorkerProgrammaticMergeReady(issue connector.Issue, cfg Config) bool {
	return mergeWorkerCheckedPullRequest(issue) && !gate.AutomatedReviewPending(cfg.AutoPromote.Gate, issue.PullRequest.AutomatedReviewPending()) &&
