...
-- association between that issue and what it was asked to do -- the same shape
-- coordinator_items uses for coordinator turns.
--
...
-- The claim gate and the dispatcher resolve an action from the issue the
-- merge queue handed the runner.
